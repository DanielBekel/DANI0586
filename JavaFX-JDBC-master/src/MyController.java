...
*/
    ...
    public void handleButtonAction(ActionEvent event) {
        ...
        String query = "Insert into CONAME(NAME,COURSE) VALUES('" + data1 + "','" + data2 + "')";
        try {
    ...
    public  void Pdf(){
        try {
            ...
            PdfWriter.getInstance(document, new FileOutputStream("D:/MARK.pdf"));
            document.open();
